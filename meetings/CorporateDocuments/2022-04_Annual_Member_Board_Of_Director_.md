...
5. Operations and Mission Statement Overview
   1. Purpose is primarily to:
      ...
      2. And access to properly licensed involved IP from contributors for broader use in society
      3. Enhance participants resumes and skills by association with the organization
   2. Primary Interface is Website.  Domain Names include:
      1. Sharealedger.org
      ...
      3. Ledgerlearning.com 
         ...
         6. financialsystemseducation.com is redirected to ledgerlearning.com but won't be renewed in November
      4. Sharealedger-Services.com and .org is not currently used, but could be used by Sharealedger LLC
      5. oursharedledger.com and .org are also reserved domains but not used
   3. Review Mission Statement and Goals as found on website
   4. Membership based upon signing up for e-mail notice from website
      ...
      3. __Discussion__: Can someone participate in meeting and content posting if one has not signed up to be a member?
...
6. Accounting Policy and Costs
   ...
   5. Accounting performed in the Wave application has a separate account for the non-profit
   6. Kevin Marshall, CPA, based in Flower Mound Texas provided consulting services in setting up the corporation
   7. Would be willing to provide continued services as available, suggest $300 a year to review tax returns and keep calendar
   8. Evan Stocks would be willing to perform bookkeeping services, suggest $200 a year to check accounts regularly
   9.  LLC has paid the bank about $100 in unnecessary fees for the year, and tax fines can be substantial, hundreds for missing deadlines
   10. **Proposed Resolution**: Accept accounting policies, service providers and costs, and suggested personnel
7.  Legal Counsel
